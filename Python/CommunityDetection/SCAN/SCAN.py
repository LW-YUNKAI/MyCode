    ...
    def execute(self):
        ...
        for node_name in visit_sequence:
            ...
            if self.is_core(node_name):  # a new community
                ...
                while len(queue) != 0:
                    temp = queue.pop(0)
                    if not self._G.node[temp].get("classified"):
...
if __name__ == '__main__':
    ...
    # for i in range(14):
    #     G.add_node(i)
    # edges = [(13, 9), (9, 12), (9, 8), (9, 10), (8, 7), (8, 12), (10, 11), (10, 12), (11, 7), (12, 7), (12, 11), (7, 6),
    #          (11, 6), (10, 6), (6, 3), (6, 4), (6, 0), (3, 5), (4, 5), (0, 5), (3, 2), (0, 1), (5, 2), (5, 1), (1, 2),
    #          (3, 4), (4, 0)]
